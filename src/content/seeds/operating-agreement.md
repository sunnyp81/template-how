...
title: 'LLC Operating Agreement Template (US) — Free PDF & DOCX'
h1: 'LLC Operating Agreement Template'
definitionalLede: 'An operating agreement is the internal governance document of a US limited liability company (LLC) that sets out who the members are, how the company is managed, how profits and losses are shared, and what happens when a member joins, leaves, or dies.'
primaryKeyword: 'llc operating agreement template'
searchVolume: 9000
difficulty: 12
...
builderSchema:
  ...
  sections:
    - id: company
      heading: 'Company'
      fields:
        - { id: llc_name, label: 'LLC legal name', type: text, required: true }
        - { id: state, label: 'State of formation', type: text, required: true }
        - { id: principal_address, label: 'Principal place of business', type: textarea, required: true }
        ...
        - id: tax_treatment
          ...
          options:
            ...
            - { value: partnership, label: 'Partnership (multi-member default)' }
            - { value: s_corp, label: 'S corporation election' }
            - { value: c_corp, label: 'C corporation election' }
    - id: members
      heading: 'Members & contributions'
      fields:
        - { id: members, label: 'Member names, addresses, and ownership %', type: textarea, required: true }
        - { id: capital_contributions, label: 'Capital contributions (cash, property, services)', type: textarea, required: true }
    - id: management
      heading: 'Management & voting'
      fields:
        ...
        - { id: managers, label: 'Manager name(s) (if manager-managed)', type: text, required: false }
        - id: voting_basis
          label: 'Voting basis'
          type: select
          required: true
          options:
            - { value: by_interest, label: 'By ownership percentage' }
            - { value: per_capita, label: 'Per capita (one member, one vote)' }
    - id: economics
      heading: 'Distributions & exit'
      fields:
        - { id: distribution_terms, label: 'How and when profits are distributed', type: textarea, required: true }
        - { id: buy_sell, label: 'Buy-sell / transfer provisions', type: textarea, required: false }
        - { id: dissolution, label: 'Dissolution triggers', type: textarea, required: false }
...
<aside class="tip">
**Expert tip:** The provision members most often skip is the buy-sell, and it is the one that causes the worst disputes. Decide in advance — while everyone is friendly — what happens when a member dies, divorces, goes bankrupt, or simply wants to leave. Spell out who has the right to buy the departing member's interest, exactly how that interest is valued (a fixed formula, a multiple of earnings, or an independent appraisal), and over what period it is paid. Without it, a deceased member's stake can pass to their spouse or children, and the surviving members suddenly find themselves in business with people they never chose and may not be able to work with. The buy-sell provision is cheap to write at formation and ruinously expensive to litigate later.
</aside>
...
- **SBA — Choose a business structure** — [sba.gov/business-guide/launch-your-business/choose-business-structure](https://www.sba.gov/business-guide/launch-your-business/choose-business-structure) — the Small Business Administration's overview of the LLC and how it compares to other structures.
- **IRS — Limited Liability Company (LLC)** — [irs.gov/businesses/small-businesses-self-employed/limited-liability-company-llc](https://www.irs.gov/businesses/small-businesses-self-employed/limited-liability-company-llc) — the federal tax treatment of LLCs, including the default classifications and the option to elect corporate taxation.
- **California Revised Uniform Limited Liability Company Act** — [Corporations Code §17701.01 et seq.](https://leginfo.legislature.ca.gov/faces/codesTOCSelected.xhtml?tocCode=CORP&tocTitle=+Corporations+Code+-+CORP) — an example of a state LLC act that both requires an operating agreement and supplies the default rules that apply where the agreement is silent.
...
An operating agreement governs the entity; the financial documents that entity produces live in the business hub — start with the [balance sheet](/balance-sheet/) template for the LLC's accounts. Among legal documents, an LLC that lends or borrows money will need a [promissory note](/promissory-note/); one that rents premises will need a [rental agreement](/rental-agreement/); and one that hires people will use the [offer letter](/offer-letter/) and, when staff leave, the [resignation letter](/resignation-letter/). If the LLC buys or sells assets, the [bill of sale](/bill-of-sale/) records the transfer.
