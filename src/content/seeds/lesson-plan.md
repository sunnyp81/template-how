...
title: 'Lesson Plan Template — Free (UK + US Formats)'
h1: 'Lesson Plan Template'
definitionalLede: 'A lesson plan template is a structured document that guides a teacher through the objectives, content, timing, and assessment for a single lesson or session.'
primaryKeyword: 'lesson plan template'
searchVolume: 18000
difficulty: 4
renderer: list-plan
related:
...
wordCountFloor: 1800
sources:
  - title: 'UK DfE National Curriculum — Key Stages 1 to 4'
  ...
  - title: 'Common Core State Standards Initiative'
    ...
    accessed: '2026-04-23'
  - title: 'IBO Middle Years Programme — MYP Curriculum Guide'
    url: 'https://www.ibo.org/programmes/middle-years-programme/curriculum/'
    accessed: '2026-04-23'
updated: '2026-04-23'
howTo:
  name: 'How to fill out a lesson plan template'
  steps:
    - name: 'Set the lesson context'
      text: 'Record the subject, year group or grade, the date, and the planned duration. These fields matter more than they appear to — a 30-minute lesson and a 60-minute lesson need fundamentally different structures, and getting the year group right ensures the complexity and vocabulary of the content is appropriate.'
    - name: 'Write SMART learning objectives'
      text: 'Write two to four objectives that are Specific, Measurable, Achievable, Relevant, and Time-bound. "Students will understand fractions" is not an objective. "By the end of this lesson, students will be able to identify and generate at least three equivalent fraction pairs using visual diagrams" is. The word "understand" is usually a red flag — it is not measurable. Replace it with a specific observable action: identify, calculate, describe, explain, compare, create.'
    - name: 'Link to curriculum standards'
      text: 'Reference the specific UK National Curriculum programme of study strand, US Common Core standard, GCSE specification objective, or IB MYP concept. This is not bureaucratic box-ticking — it tells any observer (an Ofsted inspector, a department head, a substitute teacher) exactly where this lesson fits in the sequence.'
    - name: 'List materials and resources'
      text: 'Everything needed to deliver the lesson: physical materials (mini-whiteboards, rulers, coloured markers), digital resources (the interactive diagram URL, the YouTube video clip), printed worksheets (state whether these need to be prepared the night before), and any technology (projector, class set of Chromebooks). A lesson plan with incomplete materials is an invitation to improvise at the worst moment.'
    - name: 'Build the lesson procedure'
      text: 'Break the lesson into timed stages: hook/starter, direct instruction, guided practice, independent practice, review or exit ticket. Assign a time allocation to each stage in minutes. The total should equal or be slightly under your lesson duration to allow for transitions. Include what students are doing at each stage, not just what the teacher is doing.'
    - name: 'Plan differentiation and assessment'
      text: 'Note what adjustments support lower-attaining students (modified resources, visual supports, peer partnering, additional scaffolding) and what extension tasks challenge higher-attaining students. Then specify how you will assess whether the objectives were met — formative assessment during the lesson (exit tickets, mini-whiteboard checks, observation) or summative assessment at a later point.'
faq:
  - q: 'What makes a good learning objective?'
    a: 'A good learning objective is observable and measurable. It states what students will be able to do at the end of the lesson, using a specific action verb (identify, calculate, compare, explain, construct) rather than vague verbs (understand, appreciate, know). The SMART framework (Specific, Measurable, Achievable, Relevant, Time-bound) is the standard test. Bloom''s taxonomy verbs are a useful reference for choosing the right cognitive level — "remember" and "understand" are lower-order; "analyse", "evaluate", and "create" are higher-order.'
  - q: 'What are UDL principles and should I include them in a lesson plan?'
    a: 'Universal Design for Learning (UDL) is a framework developed at CAST (Center for Applied Special Technology) that recommends designing lessons with multiple means of representation (presenting information in different formats), multiple means of action and expression (letting students demonstrate learning in different ways), and multiple means of engagement (offering choice and relevance). Including UDL thinking in lesson planning reduces the need for individual adaptations after the fact, because the lesson is designed to be accessible to a wider range of learners from the start.'
  - q: 'How do I differentiate in a lesson plan?'
    a: 'Differentiation addresses the range of ability, readiness, and learning style in a class. In a lesson plan, note: what scaffolding supports students working below age-related expectations (worked examples, sentence starters, visual word banks, peer support); what extension tasks or higher-order questions challenge students working above expectations. For students with EHCPs (England) or IEPs (US), note specific accommodations — extended time, modified text, preferential seating, a support assistant.'
  - q: 'What is the difference between formative and summative assessment?'
    a: 'Formative assessment happens during the learning process and informs what happens next — an exit ticket at the end of a lesson, a mini-whiteboard check during practice, targeted questions during discussion. Summative assessment happens at the end of a unit or course and judges overall achievement — an end-of-unit test, a GCSE exam, a portfolio submission. Both should appear in a lesson plan: formative assessment within the lesson structure, and a note on how this lesson''s learning connects to future summative assessment.'
  - q: 'How does the UK National Curriculum differ from US Common Core?'
    a: 'The UK National Curriculum is a statutory framework for state-funded schools in England covering ages 5–16, organised by key stages (KS1: Years 1–2; KS2: Years 3–6; KS3: Years 7–9; KS4: Years 10–11). It specifies programmes of study for each subject by key stage. The US Common Core State Standards (CCSS) are a voluntary set of K–12 standards in English Language Arts and Mathematics, adopted by most states but not federally mandated. Both provide the curriculum benchmarks that lesson objectives should reference; the right one depends on which country and which school type the template is used in.'
  - q: 'How long should a lesson plan be?'
    a: 'A single-page lesson plan is sufficient for most lessons. A full-page plan with all required fields covered is appropriate for a standard lesson. Two pages may be needed for a complex lesson with multiple stages or a lot of differentiation detail. The lesson plan is a working document, not a written examination — it should be detailed enough to be useful during the lesson without being so verbose that you cannot find the key information during delivery.'
  - q: 'Do I need to write a lesson plan for every lesson?'
    a: 'Experienced teachers do not necessarily write a full template-format lesson plan for every lesson — they hold much of the structure in memory and annotate briefly. For student teachers, newly qualified teachers (NQTs/ECTs in England), and teachers in formal observation periods, a full written plan is expected and serves as evidence of preparation. The template here is designed for those contexts, but experienced teachers use it selectively for complex or unfamiliar lessons.'
  - q: 'How do I adapt a lesson plan for students with IEPs or EHCPs?'
    a: 'Review the student''s IEP (US) or EHCP (England) before planning. Note the specific accommodations required — extended time, modified reading level, visual supports, a communication device, a support assistant, sensory accommodations. In the differentiation section of the lesson plan, record these explicitly. Do not assume accommodations will be obvious during delivery — writing them into the plan ensures they are not forgotten, especially during a complex lesson or when a supply teacher takes the class.'
  - q: 'Can I use this lesson plan template for training or corporate learning?'
    a: 'Yes. The structure — objectives, materials, procedure with time allocation, differentiation, and assessment — translates directly to training session design. Corporate learning uses slightly different terminology (learning outcomes rather than learning objectives, participants rather than students) but the structure is the same. The template works for any planned instructional session, not only school classroom settings.'
  - q: 'What is the hook or starter and why does it matter?'
    a: 'The hook is the opening activity — typically the first five to ten minutes — designed to activate prior knowledge, generate curiosity, or establish the relevance of the lesson. Research on attention and memory suggests that the first few minutes of a lesson determine how engaged students will be throughout, and that linking new content to prior knowledge (schema activation) significantly improves retention. A hook does not need to be elaborate — a provocative question, a surprising statistic, a brief video clip, a physical object, or a quick puzzle can all serve the purpose.'
builderSchema:
  slug: lesson-plan
  title: 'Lesson Plan'
  renderer: list-plan
  sections:
    - id: lesson_info
      ...
      fields:
        ...
        - { id: year_group, label: 'Year group / grade', type: text, required: true }
        - { id: duration, label: 'Lesson duration (minutes)', type: number, required: true }
        - { id: lesson_date, label: 'Lesson date', type: date, required: false }
        - { id: teacher, label: 'Teacher name', type: text, required: false }
    - id: objectives
      heading: 'Learning Objectives'
      fields:
        - { id: objective_1, label: 'Objective 1 (SMART)', type: textarea, required: true }
        - { id: objective_2, label: 'Objective 2 (SMART)', type: textarea, required: false }
        - { id: objective_3, label: 'Objective 3 (optional)', type: textarea, required: false }
    - id: standards
      heading: 'Curriculum Standards'
      fields:
        - id: curriculum
          ...
          required: false
          options:
            - { value: uk_nc, label: 'UK National Curriculum' }
            - { value: us_ccss, label: 'US Common Core' }
            - { value: gcse, label: 'GCSE specification' }
            - { value: ib_myp, label: 'IB MYP' }
            - { value: other, label: 'Other / free text' }
        - { id: standard_reference, label: 'Standard reference or code', type: text, required: false }
    - id: materials
      heading: 'Materials & Resources'
      fields:
        - { id: materials_list, label: 'Materials needed (one per line)', type: textarea, required: false }
    - id: procedure
      heading: 'Lesson Procedure'
      fields:
        - { id: hook, label: 'Hook / starter activity and time (e.g. 10 min)', type: textarea, required: true }
        - { id: instruction, label: 'Direct instruction and time', type: textarea, required: true }
        - { id: practice, label: 'Guided / independent practice and time', type: textarea, required: true }
        - { id: review, label: 'Review / exit ticket and time', type: textarea, required: false }
    - id: differentiation
      heading: 'Differentiation & Assessment'
      fields:
        - { id: support, label: 'Support for lower-attaining or SEND students', type: textarea, required: false }
        - { id: extension, label: 'Extension for higher-attaining students', type: textarea, required: false }
        - { id: assessment, label: 'Formative assessment method', type: textarea, required: false }
---
...
<aside class="tip">
The most common reason lesson plans fail in delivery is unrealistic time allocation. Teachers who plan a ten-minute starter, a twenty-minute direct instruction, a twenty-minute independent task, and a ten-minute plenary in a fifty-minute lesson have forgotten about transition time, distributing materials, students settling, and the inevitable question that takes three minutes longer than expected. A rule of thumb I use: plan the lesson to fill eighty percent of the available time, not one hundred percent. The ten percent buffer on each end of the lesson is real — starting after register and packing up before the bell consume more time than most plans allow for. A plan that runs to time means a plan that was not ambitious enough; a plan with a buffer means a lesson that ends with learning rather than with a rushed plenary.
</aside>
