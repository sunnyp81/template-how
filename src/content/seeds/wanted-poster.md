...
title: 'Wanted Poster Template — Free Printable (Old West + Classroom)'
h1: 'Wanted Poster Template'
definitionalLede: 'A wanted poster template is a pre-formatted design document styled in the tradition of 19th-century Old West law enforcement notices — featuring bold slab serif typography, "WANTED" or "REWARD" headlines, a central photo or portrait area, and space for fictional charges and a reward amount.'
primaryKeyword: 'wanted poster template'
searchVolume: 16000
difficulty: 5
...
wordCountFloor: 1800
sources:
  - title: 'Library of Congress — Old West Wanted Posters Collection'
    url: 'https://www.loc.gov/collections/'
    accessed: '2026-04-23'
  - title: 'Smithsonian National Museum of American History — Law and Justice Collections'
    url: 'https://americanhistory.si.edu/collections'
    accessed: '2026-04-23'
updated: '2026-04-23'
howTo:
  name: 'How to create a wanted poster'
  steps:
    - name: 'Choose a slab serif or wood-type font for the headline'
      text: 'The visual language of a wanted poster is defined by its typography. Rockwell, Clarendon, or Playbill (a display wood-type face) are the closest free options. The headline "WANTED" should be in all-caps, bold, and large enough to be read from several feet away. Use a second, lighter weight typeface for body text.'
    - name: 'Set the background and paper texture'
      text: 'An aged kraft paper texture instantly establishes the period aesthetic. Free aged-paper textures are available on Unsplash and from Freepik (search "aged paper texture free commercial use"). If printing in a classroom, a simple cream or tan background printed on standard paper achieves the look without a texture overlay.'
    - name: 'Add the central photo or portrait area'
      text: 'In authentic wanted posters, this was a photograph (usually a mugshot) or a hand-drawn portrait. For classroom use, insert a student-drawn portrait, a period illustration, or a Wikimedia Commons image. For party use, insert a photo of the subject (with their consent). Add a simple thin black border or a decorative frame around the image.'
    - name: 'Fill in the charges and reward'
      text: 'Below or beside the portrait: list the subject''s name (real or fictional), their supposed offence(s), and the reward amount. For historical classroom projects, use period-appropriate currency and charges (horse theft, stagecoach robbery, impersonating a US marshal). For escape room or party use, make the charges amusing and clearly fictional.'
    - name: 'Add the issuing authority and legal caveat'
      text: 'Authentic posters named the law enforcement agency or individual posting the reward ("By Order of the US Marshal, Territory of Arizona"). For modern use, add a small note clarifying the poster is fictional — "For entertainment and educational use only. No real persons were charged." This matters.'
faq:
  - q: 'What is the origin of the wanted poster?'
    a: 'Wanted posters as a formalised communication tool date to the mid-19th century in the United States, when the expansion of the frontier outpaced the reach of organised law enforcement. The US Postal Service and later the Pinkerton National Detective Agency distributed circulars with descriptions and, eventually, photographs of wanted individuals. The Library of Congress holds extensive collections from the period.'
  - q: 'What fonts look most authentic for a wanted poster?'
    a: 'Rockwell (a geometric slab serif, available in Microsoft Office) and Clarendon (available on Adobe Fonts) are the most commonly used. Playbill and Wanted (a decorative display font specifically designed to evoke the genre) are available free on Google Fonts and similar sources. For the body text, a condensed serif like Courier New or a light slab serif works well.'
  - q: 'Where can I find free aged-paper textures?'
    a: 'Unsplash.com (search "kraft paper texture" — filter for free commercial use), Freepik.com (same search, free tier available), and Subtlepatterns.com for tileable patterns. For a classroom project, printing the template on cream or light tan card stock achieves a similar effect without needing a texture overlay.'
  - q: 'Can I use a wanted poster template for a school history project?'
    a: 'Yes — this is one of the most popular classroom applications. History teachers at KS3 and KS4 (UK) and middle and high school (US) use wanted poster projects for topics including the American Old West, Roman history, medieval outlaws, pirates, and the English Civil War. The format engages students in research and creative writing simultaneously.'
  - q: 'What sizes should I print a wanted poster?'
    a: 'Standard print sizes: A4 (210×297mm) or US Letter (8.5"×11") for classroom and desktop use. A3 (297×420mm) or Tabloid (11"×17") for display purposes — party decoration, classroom wall display, escape room prop. A1 or Poster size (594×841mm) for theatrical or exhibition use. Scale the typography accordingly — what reads at A4 needs to be significantly larger at A1.'
  - q: 'Is it legal to make a wanted poster with a real person''s photo?'
    a: 'Never make a wanted poster that identifies a real, named person as a criminal or fugitive unless they genuinely are — which requires a court order, not a template. Even for joke purposes, depicting a real person as a wanted criminal can constitute defamation. For party use, get explicit consent from the subject and make the fictional nature unmistakably clear on the poster.'
  - q: 'What makes a wanted poster good for an escape room?'
    a: 'In an escape room, the wanted poster typically introduces a character, establishes backstory, or provides a clue (a coded reward amount, a name anagram, a location hidden in the charges). Keep the design readable under low light. Include at least one detail that will matter later — a reference number, a date, a partial address. The design should look aged and authentic to maintain immersion.'
  - q: 'Can I customise the template for a birthday party?'
    a: 'Yes — "Wanted for being AMAZING at 40" or "Wanted: World''s Best Dad" are popular personalised party decoration formats. Insert a fun photo of the birthday person, invent absurd charges ("guilty of excessive dancing," "armed with questionable puns"), and a faux reward amount. Print on cardstock and display at the venue.'
---
...
<aside class="tip">
**Expert tip:** For classroom wanted poster projects, add a research requirement to the brief: students must cite at least two sources for the charges they list. This transforms the creative project into a genuine historical research task. For a Roman history project, that means looking up the actual historical record of an emperor's crimes (Suetonius' *Lives of the Twelve Caesars* is freely available online in translation). The research reinforces the history learning; the poster format makes the presentation engaging.
</aside>
