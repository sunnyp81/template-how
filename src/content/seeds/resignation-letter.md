...
title: 'Resignation Letter Template (US + UK) — Free PDF & DOCX'
h1: 'Resignation Letter Template'
definitionalLede: 'A resignation letter is a short, formal document in which an employee notifies their employer that they are leaving their job, states their final working day, and starts the contractual or statutory notice period running.'
primaryKeyword: 'resignation letter template'
searchVolume: 12000
difficulty: 15
renderer: letter
related:
...
wordCountFloor: 1800
sources:
  - title: 'Acas — Notice periods (resigning)'
    url: 'https://www.acas.org.uk/notice-periods/notice-when-resigning'
    accessed: '2026-06-06'
  - title: 'Acas — Resignation, retirement and dismissals'
...
howTo:
  ...
  steps:
    - name: 'State that you are resigning and from what role'
      text: 'Open with one unambiguous sentence: "I am writing to formally resign from my position as [job title] at [company]." Do not bury the decision in pleasantries. The reader needs to know in the first line that this is a resignation, not a request or a discussion.'
    - name: 'Give your last working day'
      text: 'Name the exact date your employment will end, calculated from your notice period. "My last working day will be Friday, 20 June 2026" is precise. "In two weeks" is not — it forces HR to do the arithmetic and invites disputes about exactly when notice was given.'
    - name: 'Keep the tone neutral or warm'
      text: 'Thank the employer briefly for the opportunity. Resist the urge to explain grievances, criticise managers, or justify your decision in detail. This letter goes in your personnel file and may be read by people you have never met when a future employer requests a reference.'
    - name: 'Offer to help with the transition'
      text: 'A single sentence offering to train a replacement or hand over projects signals professionalism and protects the relationship. It is optional, but it is the cheapest goodwill you will ever buy.'
    - name: 'Sign off formally'
      text: 'Close with "Yours sincerely" (UK) or "Sincerely" (US), your handwritten or typed signature, and your name. Date the letter at the top — the date of the letter is the date notice is deemed given.'
faq:
      ...
      fields:
        - id: notice_period
          ...
          options:
            ...
            - { value: custom, label: 'Custom (set last working day below)' }
        ...
        - id: reason_tone
          ...
          required: false
          options:
            - { value: none, label: 'No reason stated' }
            - { value: new_opportunity, label: 'New opportunity' }
            - { value: personal, label: 'Personal reasons' }
            - { value: relocation, label: 'Relocation' }
    - id: body
      heading: 'Body & sign-off'
      fields:
        - { id: gratitude_note, label: 'Thank-you note (optional)', type: textarea, required: false }
        - { id: transition_offer, label: 'Offer to help with the transition', type: checkbox, required: false }
        - { id: signoff, label: 'Sign-off', type: text, required: true }
---
...
<aside class="tip">
**Expert tip:** Never resign until you have the new offer in writing and any contingencies (references, background checks, right-to-work verification) are cleared. Verbal offers are withdrawn more often than people expect, and a resignation cannot be unilaterally retracted. If you have signed a new contract, re-read your current contract's notice and any restrictive covenants — non-compete and non-solicit clauses survive your resignation, and in the UK garden leave can keep you on the bench for the whole notice period. Resign only once the bridge ahead is solid, because the one behind you closes the moment your manager reads the letter.
</aside>
...
If your resignation is one step in a job move, the [offer letter](/offer-letter/) template covers the document at the other end of the same transition, and the [two weeks notice](/two-weeks-notice/) page is the US-specific short-notice version of this letter. When you need a recommendation from the employer you are leaving, the [reference letter](/reference-letter/) and [letter of recommendation](/letter-of-recommendation/) templates handle that. If you are leaving to start your own business, the [operating agreement](/operating-agreement/) template sets up the LLC you may be forming. And the [cover letter](/cover-letter-google-docs/) template in the careers hub is the document that started the move in the first place.
