...
title: 'Meeting Agenda Template — Free Professional & Printable'
h1: 'Meeting Agenda Template'
definitionalLede: 'A meeting agenda is a document circulated before a meeting that lists the topics to be discussed, the order and time allocated to each, who leads them, and the desired outcome — so the meeting starts with shared expectations and stays on track.'
...
wordCountFloor: 1800
sources:
  - title: 'Harvard Business Review — How to Design an Agenda for an Effective Meeting'
    url: 'https://hbr.org/2015/03/how-to-design-an-agenda-for-an-effective-meeting'
    accessed: '2026-06-06'
  - title: 'Robert''s Rules of Order — Official Site'
    url: 'https://robertsrules.com/'
    accessed: '2026-06-06'
updated: '2026-06-06'
howTo:
  name: 'How to write a meeting agenda'
  steps:
    - name: 'State the meeting purpose and the outcome you want'
      text: 'At the top, write the single objective of the meeting in one sentence — what must be true when it ends. "Decide the Q3 launch date" is a purpose; "discuss the launch" is not. If you cannot state a clear outcome, question whether the meeting needs to happen at all.'
    - name: 'List topics as questions, not labels'
      text: 'Frame each agenda item as the question the group must answer — "Which vendor do we choose for the rebuild?" rather than "Vendor discussion". Questions make it obvious when an item is resolved and keep the discussion targeted at a decision rather than wandering around a topic.'
    - name: 'Assign an owner and a time to each item'
      text: 'Give every item a named person who leads it and a realistic time allocation. The owner is accountable for moving that item; the time box keeps the meeting honest. Totalling the time boxes against the meeting length immediately reveals an over-stuffed agenda.'
    - name: 'Order items by priority, not habit'
      text: 'Put the most important item near the start, when energy and attention are highest — not buried after fifteen minutes of routine updates. If the meeting overruns, the items that get cut should be the least important ones at the end, not the decision you actually called the meeting to make.'
    - name: 'Circulate it in advance'
      text: 'Send the agenda to attendees before the meeting — ideally 24 hours ahead — with any pre-reading attached. People arrive prepared, the meeting starts on substance instead of orientation, and anyone who spots a missing item can raise it before, not during. An agenda revealed at the start of the meeting captures few of these benefits.'
faq:
  - q: 'What is the difference between a meeting agenda and meeting minutes?'
    a: 'An agenda is written before the meeting and lists what will be discussed; minutes are written during or after and record what was discussed, decided, and assigned. The agenda is the plan; the minutes are the record. They are complementary and pair naturally — a well-structured agenda makes minutes easy to take, because the minute-taker simply records the outcome against each pre-listed item. Many organisations build their minutes directly on the agenda structure, adding decisions and action items beneath each topic.'
  - q: 'What should a meeting agenda include?'
    a: 'The essentials: the meeting title, date, time, and location (or video link); the purpose or objective in one line; the list of attendees; and the agenda items themselves, each ideally with an owner, a time allocation, and the desired outcome. Useful additions: any pre-reading or materials, a note of the previous meeting''s action items to review, and an "any other business" slot at the end. The core that makes an agenda effective is the per-item owner, time, and outcome — not just a list of topic labels.'
  - q: 'How do I keep a meeting on time using the agenda?'
    a: 'Assign each item a time box and treat it as a real constraint. Appoint a timekeeper (or use the chair) to flag when an item is approaching its limit. When discussion exceeds the box, make an explicit decision: extend it by stealing time from a later item, or "park" the topic for follow-up offline and move on. The discipline is announcing the choice rather than letting one item silently consume the meeting. Totalling the time boxes when you write the agenda is the first defence — it stops you scheduling 90 minutes of content into a 60-minute meeting.'
  - q: 'Why frame agenda items as questions?'
    a: 'Because a question has a clear finish line and a label does not. "Vendor discussion" can ramble indefinitely — there is no signal that it is done. "Which vendor do we choose, and by when?" is resolved the moment the group answers it, which keeps the conversation aimed at a decision instead of circling the topic. Harvard Business Review specifically recommends framing agenda items as questions for this reason: it converts vague discussion items into concrete problems to solve, and makes it obvious to everyone when to move on.'
  - q: 'Should I send the agenda before the meeting?'
    a: 'Yes — ideally at least 24 hours in advance, with any pre-reading attached. Circulating the agenda early lets people prepare, surfaces missing items before the meeting rather than during it, and lets attendees decide whether they genuinely need to be there. A meeting that opens with everyone reading the agenda for the first time wastes its opening minutes on orientation. The agenda is most powerful as a pre-meeting tool that shapes preparation, not as a sheet handed out as people sit down.'
  - q: 'How long should a meeting agenda be?'
    a: 'Short enough to complete in the meeting''s length with buffer. A 30-minute meeting realistically holds two or three substantive items; a one-hour meeting, three to five. The constraint is the total of the time boxes, not the number of lines. The most common agenda mistake is over-stuffing — listing eight items for a 45-minute meeting, guaranteeing that the last few are rushed or skipped. If you have more to cover than fits, either lengthen the meeting, split it, or move some items to asynchronous discussion.'
  - q: 'What is "any other business" (AOB)?'
    a: 'AOB is a slot, usually at the end of the agenda, for items not formally listed — minor points, brief announcements, or things that arose too late to add. It is a useful pressure valve, but it should stay genuinely minor: substantive topics deserve their own agenda item with proper time, not a rushed mention under AOB. Some chairs ask for AOB items at the start so they can judge timing. Keep AOB tightly controlled, or it becomes the unplanned overrun that derails an otherwise well-timed meeting.'
  - q: 'How do agendas work with Robert''s Rules of Order?'
    a: 'Robert''s Rules of Order is a formal parliamentary procedure used by boards, committees, associations, and councils. Under it, a standard "order of business" structures the agenda: call to order, approval of previous minutes, reports (officers, committees), unfinished/old business, new business, and adjournment. Formal motions, seconds, and votes happen within the new-business items. If your group runs on Robert''s Rules, your agenda follows this fixed order; for ordinary team or business meetings, a simpler purpose-and-items structure is more practical and less ceremonial.'
  - q: 'Who should own each agenda item?'
    a: 'The person best placed to lead that item — usually whoever raised it, owns the relevant work, or holds the decision. Naming an owner per item does two things: it ensures someone has prepared to lead the discussion rather than everyone looking around the room, and it creates accountability for moving the item to a conclusion. The chair owns the meeting as a whole and keeps time; individual item owners drive their topics. An agenda where every item is implicitly "everyone" tends to drift.'
  - q: 'How do I run a recurring meeting agenda?'
  ...
  sections:
    - id: meeting_info
      ...
      fields:
        ...
        - { id: time, label: 'Time (start–end)', type: text, required: false }
        - { id: location, label: 'Location / video link', type: text, required: false }
        - { id: chair, label: 'Chair / facilitator', type: text, required: false }
        - { id: purpose, label: 'Purpose / desired outcome (one line)', type: textarea, required: true }
        - { id: attendees, label: 'Attendees', type: textarea, required: false }
    - id: previous
      heading: 'Review of previous actions'
      fields:
        - { id: prev_actions, label: 'Action items from last meeting to review', type: textarea, required: false }
    - id: agenda_items
      heading: 'Agenda items'
      fields:
        - { id: item_1, label: 'Item 1 — topic (framed as a question)', type: text, required: true }
        - { id: item_1_owner, label: 'Item 1 — owner', type: text, required: false }
        - { id: item_1_time, label: 'Item 1 — time (mins)', type: text, required: false }
        - { id: item_1_outcome, label: 'Item 1 — desired outcome', type: text, required: false }
        - { id: item_2, label: 'Item 2 — topic', type: text, required: false }
        - { id: item_2_owner, label: 'Item 2 — owner', type: text, required: false }
        - { id: item_2_time, label: 'Item 2 — time (mins)', type: text, required: false }
        - { id: item_2_outcome, label: 'Item 2 — desired outcome', type: text, required: false }
        - { id: item_3, label: 'Item 3 — topic', type: text, required: false }
        - { id: item_3_owner, label: 'Item 3 — owner', type: text, required: false }
        - { id: item_3_time, label: 'Item 3 — time (mins)', type: text, required: false }
        - { id: item_3_outcome, label: 'Item 3 — desired outcome', type: text, required: false }
        - { id: item_4, label: 'Item 4 — topic', type: text, required: false }
        - { id: item_4_owner, label: 'Item 4 — owner', type: text, required: false }
        - { id: item_4_time, label: 'Item 4 — time (mins)', type: text, required: false }
        - { id: item_4_outcome, label: 'Item 4 — desired outcome', type: text, required: false }
        - { id: item_5, label: 'Item 5 — topic', type: text, required: false }
        - { id: item_5_owner, label: 'Item 5 — owner', type: text, required: false }
        - { id: item_5_time, label: 'Item 5 — time (mins)', type: text, required: false }
        - { id: item_5_outcome, label: 'Item 5 — desired outcome', type: text, required: false }
    - id: close
      heading: 'Close'
      fields:
        - { id: aob, label: 'Any other business (AOB)', type: textarea, required: false }
        - { id: next_meeting, label: 'Date/time of next meeting', type: text, required: false }
        - { id: notes, label: 'Notes / pre-reading', type: textarea, required: false }
---
...
<aside class="tip">
**Expert tip:** Frame every agenda item as a question, and add the desired outcome beside it — this one change does more for meeting quality than any other. "Marketing update" is a black hole: there is no signal for when it is finished, so it expands to fill whatever time is available. "What are the two changes we''re making to the campaign after last week''s numbers?" has a clear finish line — the moment the group names the two changes, the item is done and you move on. The question format quietly converts a meeting of vague discussions into a meeting of decisions, and it gives your timekeeper an objective basis for saying "we''ve answered this, next item." When you write the agenda, read each item and ask: what question is this meant to answer? If you can''t find one, the item probably belongs in an email.
</aside>
