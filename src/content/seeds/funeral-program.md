...
title: 'Funeral Program Template — Free Order of Service (US + UK)'
h1: 'Funeral Program Template'
definitionalLede: 'A funeral program template is a printed or digital order of service distributed to mourners, listing the service sequence, hymns, readings, speakers, and tribute details — a keepsake that guides the congregation through the service and commemorates the life of the deceased.'
primaryKeyword: 'funeral program template'
searchVolume: 4700
difficulty: 12
...
wordCountFloor: 1800
sources:
  - title: 'Church of England — Order for the Funeral of an Adult (Common Worship)'
    url: 'https://www.churchofengland.org/prayer-and-worship/worship-texts-and-resources/common-worship/death-and-dying/funeral'
    accessed: '2026-04-23'
  - title: 'National Funeral Directors Association — Consumer Resources'
    url: 'https://www.nfda.org/consumer-resources'
    accessed: '2026-04-23'
updated: '2026-04-23'
howTo:
  name: 'How to create a funeral program'
  steps:
    - name: 'Gather the essential information'
      text: 'You need the full name of the deceased, dates of birth and death, the service date, time, and location, the officiant''s name, and the order of service — which readings, hymns, musical pieces, and speakers are involved, and in what order.'
    - name: 'Choose your format and size'
      text: 'The standard UK format is A5 bi-fold (folded from A4), giving four panels. In the US, a half-letter bi-fold or a single trifold letter sheet are common. The cover panel carries the photograph, name, and dates. The inside two panels carry the order of service. The back panel carries acknowledgements or a poem.'
    - name: 'Select or design the template'
      text: 'Choose a template that matches the tone and denomination of the service. Simple and elegant is almost always correct. Over-designed templates with busy backgrounds distract from the purpose. Leave space for a clear portrait photo — ideally 300dpi or higher for print.'
    - name: 'Draft the order of service'
      text: 'Work with the officiant to confirm the exact sequence of the service. Include every element in order: processional music, welcome, readings (with text if there is space), hymns (with page numbers or full lyrics), eulogies, committal, recessional. Confirm hymn titles and versions with the officiant — "Abide with Me" appears in multiple hymnbooks with slightly different versifications.'
    - name: 'Proof, print, and distribute'
      text: 'Proof the document carefully — typos in names and dates are painful and irreversible once printed. Print on cardstock (minimum 160gsm for bi-fold) or use a funeral director''s print service. Order 10–15% more copies than expected attendance. Distribute at the entrance to the venue before the service begins.'
faq:
  - q: 'How much does printing a funeral program cost?'
    a: 'In the UK, expect £30–80 for 100 bi-fold A5 programs on cardstock through a local print shop or online service (Moo.com, Vistaprint, Solopress). Funeral directors typically charge £60–150 for the same quantity, including design. In the US, $80–200 per 100 programs is typical, depending on paper quality and whether you use a funeral director or a print service like FuneralOne or Overnight Prints.'
  - q: 'Does the denomination affect the program structure?'
  ...
  - q: 'What photo should be used on the cover?'
    a: 'A dignified portrait, ideally one the deceased would have been comfortable with — not a candid or group photo cropped to show just them. The most recently used formal photo is usually best. Ensure the image is at least 300dpi at the intended print size (roughly 10x8cm for an A5 cover). A blurry photo printed at low resolution looks unprofessional and can be upsetting.'
  - q: 'How long before the service should the program be ready?'
  ...
  - q: 'Who typically receives a copy of the funeral program?'
    a: 'Everyone attending the service is given one at the entrance. Extra copies are typically kept by the immediate family, the officiant, and the funeral director. Sending copies to those who could not attend — particularly elderly or overseas relatives — is a thoughtful gesture. Digital versions can be emailed or posted online via a memorial page.'
  - q: 'Can you use a digital funeral program instead of print?'
...
<aside class="tip">
**Expert tip:** Always print 10–15% more programs than the expected attendance. Funerals frequently attract more mourners than anticipated — particularly for well-known community figures or those who died unexpectedly young. Running out of programs at the entrance is distressing for the family and disorienting for late arrivals. The cost of 20 extra sheets on cardstock is negligible.
</aside>
