...
title: 'Expense Report Template (US + UK) — Free PDF & XLSX'
h1: 'Expense Report Template'
definitionalLede: 'An expense report is a document an employee or business owner uses to list business costs they have paid personally — travel, meals, supplies, mileage — so they can be reimbursed and the spending can be recorded for accounting and tax.'
...
sources:
  - title: 'IRS — Publication 463: Travel, Gift, and Car Expenses'
    ...
    accessed: '2026-06-06'
  - title: 'HMRC — Expenses and benefits for employers (gov.uk)'
    url: 'https://www.gov.uk/expenses-and-benefits-a-to-z'
    accessed: '2026-06-06'
  - title: 'HMRC — Travel mileage and fuel rates and allowances'
    url: 'https://www.gov.uk/government/publications/rates-and-allowances-travel-mileage-and-fuel-allowances'
    accessed: '2026-06-06'
updated: '2026-06-06'
howTo:
  name: 'How to fill out an expense report'
  steps:
    - name: 'Add your details and the reporting period'
      text: 'State your name, department or role, the period the report covers, and the date you are submitting it. If your employer uses cost codes or project codes, add those so the spending is allocated correctly.'
    - name: 'List each expense as a line'
      text: 'For every cost, record the date, a description, the category (travel, meals, accommodation, supplies), the amount, and whether it includes tax. One line per receipt keeps the report auditable.'
    - name: 'Add mileage separately'
      text: 'Record business miles driven and multiply by the approved rate — the IRS standard mileage rate (US) or HMRC approved mileage allowance payment (UK). Mileage is reimbursed by the rate, not by fuel receipts, unless your employer''s policy differs.'
    - name: 'Total the report and attach receipts'
      text: 'Sum the expenses by category and overall, and attach or reference a receipt for every line. Most employers require a receipt for any expense above a small threshold; some require one for everything.'
    - name: 'Submit for approval'
      text: 'Sign or confirm the report and submit it to the approver (manager or finance). Keep a copy. The approved report is the basis for reimbursement and the supporting record for the business''s accounts and tax.'
faq:
  - q: 'What is an expense report used for?'
    a: 'An expense report serves two purposes at once. First, it lets an employee or owner who paid for business costs out of their own pocket get reimbursed, with a clear itemised record of what they spent. Second, it gives the business the documentation it needs to record those costs in its accounts and claim them against tax. The report ties each cost to a date, a category, and a receipt, which is exactly what an accountant — and a tax authority — wants to see.'
  - q: 'Do I need receipts for every expense?'
    a: 'Usually yes for anything above a small threshold, and often for everything. Both the IRS (US) and HMRC (UK) expect business expenses to be supported by records, and a receipt is the standard evidence. Many employers set a de minimis threshold (say, $25 or £25) below which a receipt is not required, but the safer habit is to keep a receipt for every business cost. For some expenses — like mileage — the evidence is a log of journeys rather than a receipt.'
  - q: 'How does mileage reimbursement work?'
    a: 'Mileage is reimbursed at an approved per-mile rate that is meant to cover fuel plus wear and running costs, rather than by claiming actual fuel receipts. In the US, the IRS publishes a standard mileage rate each year. In the UK, HMRC sets Approved Mileage Allowance Payments — a higher rate for the first 10,000 business miles in a tax year and a lower rate above that, with separate rates for cars, motorcycles, and bicycles. You record the business miles driven and multiply by the rate. Paying above the approved rate can create a taxable benefit.'
  - q: 'What expenses can I claim on an expense report?'
    a: 'Genuine business costs incurred wholly and exclusively for the work: business travel and mileage, accommodation, meals while travelling, parking and tolls, public transport, business supplies, professional subscriptions, and similar. What you cannot claim is personal spending, ordinary commuting between home and a permanent workplace, or anything your employer''s policy excludes. The "wholly and exclusively" test (UK) and the "ordinary and necessary" test (US) are the guiding principles for what counts as a legitimate business expense.'
  - q: 'Is reimbursed expense money taxable?'
    a: 'Generally no, if it is a genuine reimbursement of an allowable business expense supported by records. A straight repayment of money you spent on the business''s behalf is not income to you. It can become taxable if it exceeds the actual or approved cost (for example, mileage paid above the HMRC approved rate), if it is really disguised pay, or if the expense was not genuinely a business cost. Keeping proper records and staying within approved rates keeps reimbursements tax-free.'
  - q: 'What is the difference between an expense report and an invoice?'
    a: 'An expense report is internal: an employee or owner reports costs they personally paid, to be reimbursed by their own business. An invoice is external: a business bills a customer for goods or services. They can look similar — both itemise amounts — but they flow in opposite directions and serve different purposes. You submit an expense report to get your own money back; you send an invoice to get a customer to pay you. A contractor billing a client for expenses, by contrast, would put them on an invoice, not an internal expense report.'
  - q: 'How often should expense reports be submitted?'
    a: 'It depends on the employer''s policy, but monthly is the most common cadence, with some businesses using weekly or per-trip reports. Submitting promptly matters: it keeps reimbursements timely, stops receipts from being lost, and keeps the accounts current. Both tax authorities care about records being contemporaneous, so reporting expenses close to when they were incurred — rather than in a year-end scramble — produces cleaner, more defensible records.'
  - q: 'What records do I need to keep for tax?'
  ...
  sections:
    - id: header
      ...
      fields:
        ...
        - { id: department, label: 'Department / role', type: text, required: false }
        - { id: period, label: 'Reporting period', type: text, required: true }
        - { id: submit_date, label: 'Date submitted', type: date, required: true }
        - { id: cost_code, label: 'Cost / project code', type: text, required: false }
        - id: currency
          label: 'Currency'
          type: select
          required: true
    ...
    - id: expenses
      ...
      fields:
        - { id: expense_lines, label: 'Expenses (date, description, category, amount)', type: lineitems, required: true }
    - id: mileage
      heading: 'Mileage'
      fields:
        - { id: miles, label: 'Business miles', type: number, required: false }
        - { id: mileage_rate, label: 'Approved rate per mile', type: number, required: false }
        - { id: mileage_total, label: 'Mileage total', type: currency, required: false }
    - id: totals
      heading: 'Totals & approval'
      fields:
        - { id: subtotal, label: 'Expenses subtotal', type: currency, required: true }
        - { id: total_claim, label: 'Total reimbursement claimed', type: currency, required: true }
        - { id: receipts_attached, label: 'Receipts attached for all lines', type: checkbox, required: false }
        - { id: approver_name, label: 'Approver name', type: text, required: false }
...
<aside class="tip">
**Expert tip:** Use the approved mileage rates rather than claiming actual fuel, and know the tiers, because getting this wrong is the most common way an innocent expense claim turns into a taxable benefit. In the UK, HMRC's Approved Mileage Allowance Payments pay a higher rate for the first 10,000 business miles in the tax year and a lower rate above that — and if your employer pays you more than the approved rate, the excess is taxable and must be reported. In the US, the IRS publishes a single standard mileage rate that is updated each year, so always check the current figure rather than reusing last year's. Recording the rate and the tier on the report itself, alongside the miles, means the claim is self-documenting and an approver or auditor can see at a glance that it is within the tax-free limits.
</aside>
...
> |---|---|---|---|
> | 3 Jun | Train, Leeds–London return | Travel | £96.40 |
> | 3 Jun | Hotel, one night | Accommodation | £128.00 |
> | 3 Jun | Evening meal (away from base) | Subsistence | £24.50 |
> | 4 Jun | Lunch with client | Subsistence | £41.20 |
> | 4 Jun | Parking at station | Travel | £14.00 |
>
> **Mileage:** 60 business miles (home to station and client site) × £0.45 = £27.00
> Expenses subtotal: £304.10 · Mileage: £27.00 · **Total claimed: £331.10**
> Receipts attached for all lines. Approved by: Hannah Cole, 9 June 2026.
...
- **IRS — Publication 463: Travel, Gift, and Car Expenses** — [irs.gov/publications/p463](https://www.irs.gov/publications/p463) — the US rules on deductible business travel, the standard mileage rate, and the business-meal limits.
- **HMRC — Expenses and benefits A to Z** — [gov.uk/expenses-and-benefits-a-to-z](https://www.gov.uk/expenses-and-benefits-a-to-z) — the UK employer guidance on which reimbursed expenses are tax-free and which are reportable benefits.
- **HMRC — Travel mileage and fuel rates and allowances** — [gov.uk/government/publications/rates-and-allowances-travel-mileage-and-fuel-allowances](https://www.gov.uk/government/publications/rates-and-allowances-travel-mileage-and-fuel-allowances) — the Approved Mileage Allowance Payments and the 10,000-mile tier.
...
Expense reports record spending that flows into the same financial picture as the rest of this hub — costs that began as a [purchase order](/purchase-order/) or a job priced by an [estimate](/estimate/), and that ultimately appear in the business's accounts. A contractor billing a client for expenses uses an [invoice](/invoice-google-docs/) rather than an internal report. Spending decisions and policy are recorded in [meeting minutes](/meeting-minutes/), and a notable cost-saving or expansion can be announced with a [press release](/press-release/). The company whose expenses these are is governed by its [operating agreement](/operating-agreement/) in the legal hub.
