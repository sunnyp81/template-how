...
title: 'One Pager Template — Free (Startup Pitch, Proposal, Brief)'
h1: 'One Pager Template'
definitionalLede: 'A one pager template is a single-page document that distils a business, product, proposal, or idea into its most essential elements — designed to communicate the core case in under five minutes of reading time, without appendices, footnotes, or padding.'
primaryKeyword: 'one pager template'
searchVolume: 15000
difficulty: 3
...
wordCountFloor: 1800
sources:
  - title: "Y Combinator — YC's Simple Agreement for Future Equity (SAFE) One-Pager"
    url: 'https://www.ycombinator.com/documents'
    accessed: '2026-04-23'
  - title: 'UK Companies House — Business plan and information guidance'
    url: 'https://www.gov.uk/write-business-plan'
    accessed: '2026-04-23'
updated: '2026-04-23'
howTo:
  name: 'How to write a one pager'
  steps:
    - name: 'Define the audience and what you want them to do'
      text: 'Before writing a single word, answer two questions: who is reading this, and what action do you want them to take after reading it? A one pager for a seed investor (action: schedule a call) is different from a one pager for an internal stakeholder (action: approve the budget). The target action shapes every section.'
    - name: 'Draft each section in order: problem, solution, market, traction, team, ask'
      text: 'These six sections cover the essential case for any business or project. Write each section in two to four sentences. Do not exceed four sentences per section — if you need more, you are explaining rather than asserting. One pagers assert; business plans explain.'
    - name: 'Apply the constraint: if it does not fit on one page, cut'
      text: 'Set your document to A4 or US Letter with 1.5cm margins, 11pt body font, and attempt to fit everything. If it overflows, identify the lowest-value sentence in each section and delete it. Repeat until it fits. The constraint forces prioritisation — which forces clarity.'
    - name: 'Design for scannability'
      text: 'Use one font family with clear weight hierarchy (bold headings, regular body). Use whitespace generously — a dense one pager reads as corporate-speak. A clean one pager reads as confident. If you include numbers, make them visually prominent. Three or four bold data points anchoring the document do more work than a paragraph of text.'
    - name: 'Export as PDF and include your contact details'
      text: 'A one pager without contact details is useless — the reader cannot act on it. Include a name, email, and phone at the top or bottom. Export as PDF to preserve formatting across devices and platforms. Name the file clearly: "Nova-Labs-OnePager-April2026.pdf" is findable and professional; "document.pdf" is neither.'
faq:
  - q: 'What is the difference between a one pager and an executive summary?'
    a: 'An executive summary is a condensed introduction to a longer document — it assumes the full business plan, report, or proposal exists and frames it. A one pager is a standalone document that exists independently and is designed to be the only thing the reader sees. You can read a one pager without needing anything else. An executive summary is a gateway; a one pager is the destination.'
  - q: 'What is the difference between a one pager and a business plan?'
    a: 'A business plan is a comprehensive document — typically 20–40 pages — covering market analysis, operational plan, financial projections, risk register, and management team in full detail. It is a planning and governance document. A one pager is a communication and persuasion document. Reading a business plan takes 30–45 minutes; a one pager takes 3–5 minutes. They serve different purposes and different audiences.'
  - q: 'What is the difference between a one pager and a pitch deck?'
    a: 'A pitch deck is a slide presentation — typically 10–15 slides — designed to be presented verbally with supporting visuals. A one pager is a print or PDF document designed to be read independently without narration. One pagers are often shared before or after a pitch deck meeting, serving as a leave-behind or a primer.'
  - q: 'Does a one pager have to be exactly one page?'
    a: 'Yes. The constraint is the point. A one pager that runs to two pages is not a one pager — it is a brief. The single-page discipline forces the author to identify and eliminate everything that is not essential. Investors, clients, and busy executives receive hundreds of documents; the discipline of one page signals respect for their time.'
  - q: 'Should a one pager be landscape or portrait orientation?'
    a: 'Portrait (vertical) is the default and works for most use cases. Landscape is occasionally used for highly visual product one pagers or investor tear sheets where a wider layout better accommodates charts or images. Portrait is safer for email attachment and printing; landscape can be awkward to read on mobile devices.'
  - q: 'What file format should I use for a one pager?'
    a: 'PDF is standard. It preserves formatting across devices and prevents inadvertent editing. Name the file descriptively and include the date or version. Do not share .docx one pagers externally — fonts may render differently, and a misaligned one pager looks unprofessional immediately.'
  - q: 'How does a Y Combinator SAFE one-pager work?'
    a: 'A Y Combinator SAFE (Simple Agreement for Future Equity) is itself a short, standardised investment document — but YC has also published a one-pager format for companies to summarise their investment ask alongside the SAFE document. This YC-style one pager covers: what the company does, the team, current traction, use of funds, and the valuation cap. It accompanies the SAFE rather than replacing it.'
  - q: 'Can a one pager replace a full business plan?'
    a: 'For initial outreach, seed rounds, and early commercial conversations — often yes. Many seed-stage investors make a preliminary decision to engage based on a one pager alone, before requesting a full deck or financial model. For bank lending, grant applications, or formal board approval, a full business plan is still required. Use the one pager to open doors; have the full plan ready when they ask.'
  - q: 'What tools should I use to create a one pager?'
    a: 'Figma (professional quality, free tier available) and Canva (simpler, free tier available) are the most popular design tools. Google Slides and PowerPoint can produce clean one pagers if you start from a blank slide at A4 size. Microsoft Word and Google Docs work but require more discipline to achieve clean visual hierarchy. Notion is occasionally used for internal one pagers but does not export at print quality.'
---
...
<aside class="tip">
**Expert tip:** Test your one pager with someone who has no context — ideally outside your industry. Give them 3 minutes to read it, then ask: "What do we do? What are we asking for?" If they cannot answer both questions accurately, the one pager is not doing its job. Most one pager failures are not design failures — they are clarity failures that better design cannot fix.
</aside>
