...
title: 'Roblox Shirt Template — Free 585×559 PNG Download'
h1: 'Roblox Shirt Template'
definitionalLede: 'A Roblox shirt template is a 585×559 pixel PNG file with UV-mapped front, back, and sleeve panels that you fill with your design before uploading to Roblox — where it can be worn by your avatar or listed for sale on the Creator Marketplace.'
primaryKeyword: 'roblox shirt template'
searchVolume: 35000
difficulty: 13
...
wordCountFloor: 1800
sources:
  - title: 'Roblox Creator Documentation — Classic Clothing'
    url: 'https://create.roblox.com/docs/art/accessories/classic-clothing'
    accessed: '2026-04-23'
  - title: 'Photopea Documentation'
    url: 'https://www.photopea.com/learn/'
    accessed: '2026-04-23'
updated: '2026-04-23'
howTo:
  name: 'How to make a Roblox shirt'
  steps:
    - name: 'Download the template PNG'
      text: 'The shirt template is a 585×559 pixel PNG file divided into panels. Open it in your image editing software. Do not resize it — the dimensions must stay at exactly 585×559 or the panels will misalign on the 3D avatar.'
    - name: 'Identify the panels'
      text: 'The template is a UV unwrap: the front panel is the large central section, the back panel is the section directly to its right, the left and right sleeves are the rectangular panels above. There are also small sections for the torso sides. Add your design to the correct panels for where you want it to appear on the avatar.'
    - name: 'Add your design in a new layer'
      text: 'Work on a layer above the template guide layer, not on the template layer itself. This allows you to toggle the guide off before saving. Keep the guide layer visible while designing to see panel boundaries.'
    - name: 'Save as PNG with transparent background'
      text: 'The background of your shirt file must be transparent (not white). When you are ready to save, delete or hide the template guide layer, then export as PNG. Do not save as JPG — JPG does not support transparency and will produce a white background that looks wrong on the avatar.'
    - name: 'Upload to Roblox'
      text: 'Go to create.roblox.com, select "Manage Experience" or go to "Create" > "Classic Shirts." Upload your PNG. Uploading costs 10 Robux. Roblox moderation reviews the design, typically within a few hours. If approved, the shirt appears in your inventory. If you want to sell it, you must be in the UGC Programme.'
faq:
  - q: 'What are the exact dimensions of the Roblox shirt template?'
    a: '585 pixels wide by 559 pixels tall. This is a fixed specification from Roblox. Do not scale the file up or down before uploading. The template file itself should be saved at exactly these dimensions with 72 DPI (DPI does not actually affect the upload, but 72 is the standard working resolution for screen assets).'
  - q: 'What software can I use to edit the template if I do not have Photoshop?'
    a: 'Photopea (photopea.com) is a free, browser-based Photoshop alternative that opens PSD files and supports layers, PNG transparency, and all the features you need for a Roblox shirt. GIMP is a free desktop alternative. Krita is another free option used by many creators. Canva can export as PNG but has limited layer support and no transparency-background PNG export in the free version. Photopea is the most widely recommended free option for Roblox clothing design.'
  - q: 'How much does it cost to upload a shirt to Roblox?'
    a: 'Uploading a classic shirt costs 10 Robux, which is approximately £0.10 or $0.10 at the standard Robux exchange rate (1,000 Robux = approximately £9.50 or $10 in 2026). This fee applies regardless of whether the shirt is approved or not — if your upload is rejected by moderation, you still spend the 10 Robux.'
  - q: 'Why was my shirt rejected by Roblox moderation?'
    a: 'The most common reasons for rejection: (1) the design contains a real-world brand logo or trademark; (2) the design resembles a copyrighted character or image; (3) the design is too close to adult content, violent imagery, or hate symbols; (4) the file was uploaded as JPG rather than PNG, creating a white background that Roblox flags as a formatting error. If you believe the rejection was in error, you can appeal through the Roblox support system, but appeal outcomes are inconsistent.'
  - q: 'Do I need to be in the UGC Programme to sell shirts?'
    a: 'To sell items on the Roblox Creator Marketplace, you must be a member of the UGC (User-Generated Content) Programme. Programme membership requires applying and being accepted by Roblox. Without programme membership, you can upload shirts for your own avatar''s use but cannot list them for sale. As of 2026, Roblox has been progressively opening UGC access to more creators.'
  - q: 'How does the Roblox revenue share work for shirt sales?'
    a: 'When you sell a shirt on the Creator Marketplace, Roblox takes 30% of the sale price and you receive 70% in Robux. To convert Robux to real currency (USD), you must use the Developer Exchange (DevEx) programme, which requires at least 30,000 Robux earned, a verified account, and a linked PayPal or bank account. At current rates, 100,000 Robux = approximately $350 USD via DevEx — a lower rate than the purchase rate.'
  - q: 'Can I use fan art or logos from games, shows, or brands on my shirt?'
    a: 'No — at least not for uploaded shirts on Roblox. Using copyrighted characters, brand logos, or recognisable imagery from games, films, TV shows, or sports teams violates both Roblox''s Terms of Service and copyright law. Roblox moderation will remove such shirts. For personal use on your own avatar, the enforcement is lighter, but it still violates the rules. Original designs or designs using genuinely royalty-free elements are the safe approach.'
  - q: 'What detail level works for a 585×559 pixel design?'
    a: 'At this resolution, fine details smaller than about 5–6 pixels will be nearly invisible once the texture wraps around the 3D avatar. Text is particularly problematic — anything smaller than about 12-14 pixels in the file will be unreadable in-game. Bold, high-contrast designs with clear shapes work better than detailed, photorealistic graphics at this resolution. Test your design by zooming out to 50% in your editing software and assessing legibility.'
---
...
<aside class="tip">
**Expert tip:** Before uploading your final design, take a screenshot of your avatar wearing a similar colour shirt (or just in their default outfit) and overlay your shirt texture at reduced opacity. This gives you a rough preview of how the texture will look in 3D before spending the 10 Robux upload fee. It is not a perfect preview, but it will catch major placement errors — like a chest logo that is actually landing on the shoulder because you misjudged the panel boundaries. The free avatar preview tools on third-party Roblox community sites can also show an approximate 3D render of your texture before upload, which is worth using for any design you are planning to sell.
</aside>
