---
slug: life-event-templates
label: Life events
headline: Life event templates for the moments that matter most — and the ones that are hardest to write
lede: Document templates for births, deaths, graduations, weddings, and seasonal milestones — the occasions where the right words matter more than the format, but both have to be right.
seeds:
  - obituary
  - family-tree
  - funeral-program
...
- **The Times obituary submission guidelines** — [thetimes.com/obituaries](https://www.thetimes.com/obituaries) — word limits, submission process, and what the editors expect from reader-submitted death notices.
- **National Funeral Directors Association (NFDA, US)** — [nfda.org](https://www.nfda.org) — the authoritative US source on funeral service conventions, obituary formats, and programme standards.
- **General Register Office (UK)** — [gov.uk/general-register-office](https://www.gov.uk/general-register-office) — official UK source for birth, death, and marriage certificate information, useful for verifying family tree data.
- **The Guardian obituaries** — [theguardian.com/tone/obituaries](https://www.theguardian.com/tone/obituaries) — accessible archive showing the structural conventions used by the UK's leading broadsheet obituary section.

<aside class="tip">
**Expert tip:** For funeral programmes, design the cover last, not first. Families often get stuck on the cover photo — choosing the right image, the right caption — and run out of time for the interior. The interior (order of service, hymn numbers, readings) is what guides the service and what attendees actually use during the ceremony. Get the content right first; the cover is a keepsake. A programme with a slightly imperfect photo and a correct order of service serves everyone better than a beautiful cover and a chaotic interior.
</aside>

## Related categories

**[Legal document templates](/legal-document-templates/)** — Death triggers legal documents. A last will and testament, an estate administration letter, and potentially an eviction notice (if the deceased was a tenant) all live in the legal cluster. If you are organising a funeral, you will likely need to interact with both clusters. Probate in England and Wales is administered through the Probate Registry (part of HMCTS).

**[Business templates](/business-templates/)** — Graduation celebrations, baby showers, and significant birthdays sometimes involve hired venues, caterers, or event planners — all of whom will require invoices and contracts. The business cluster covers those operational documents.

**[Resume & career templates](/resume-templates/)** — Graduation is a career transition. A graduation celebration template in this cluster and a first-job resume template in the careers cluster are often needed in the same week. The two clusters are frequently used in sequence.

**[Planning templates](/planning-templates/)** — Funeral planning, baby arrival preparation, and event organisation all involve schedules, itineraries, and checklists. The planning cluster — particularly travel itinerary and weekly schedule templates — supports the logistical side of major life events.

**[Design templates](/design-templates/)** — Birthday invitations and Christmas cards with custom visual designs fall in the overlap between this cluster and the design cluster. If you need a visually distinctive invitation rather than a text-formatted one, the design templates (particularly Canva-based formats) are the right starting point.

**[Education templates](/education-templates/)** — Graduation sits on the boundary between education and life events. The academic side of graduation (transcripts, letters of recommendation) lives in the education cluster; the celebratory side (invitations, programmes) lives here.

**[Productivity templates](/productivity-templates/)** — Planning a wedding, a significant birthday party, or a funeral involves project management. Checklists, to-do lists, and sign-up sheets from the productivity cluster are practical companions to the life-event documents in this cluster.
