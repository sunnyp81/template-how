---
slug: planning-templates
label: Planning & scheduling
headline: Planning and scheduling templates that translate intentions into structured time
lede: Schedule, calendar, and planning templates for lessons, travel, meals, births, and weekly life — built around proven time-management frameworks and real curriculum standards for both the UK and US.
seeds:
  - lesson-plan
  - travel-itinerary
  - itinerary
...
- **UK Department for Education — National Curriculum** — [gov.uk/national-curriculum](https://www.gov.uk/national-curriculum) — the statutory programmes of study for each Key Stage in England, last revised for the 2014 curriculum.
- **Council of Chief State School Officers (CCSSO) — Common Core State Standards** — [corestandards.org](http://www.corestandards.org) — the original CCSS documents for English Language Arts and Mathematics, with standards by grade level.
- **NHS — Your birth plan** — [nhs.uk/pregnancy/labour-and-birth/preparing-for-the-birth/your-birth-plan](https://www.nhs.uk/pregnancy/labour-and-birth/preparing-for-the-birth/your-birth-plan) — the NHS guidance on birth plans, covering what to include and how midwives use them.
- **Ofsted Education Inspection Framework 2023** — [gov.uk/government/publications/education-inspection-framework](https://www.gov.uk/government/publications/education-inspection-framework) — the criteria inspectors use to evaluate the quality of education, including lesson plan expectations.

<aside class="tip">
**Expert tip:** The most underused field in any lesson plan template is the "prior knowledge" section. Teachers consistently plan for what students will do in the lesson without explicitly stating what students need to already know for the lesson to work. When this field is filled in properly, it does three things: it forces the teacher to check whether that prior knowledge was actually taught in previous lessons, it enables a substitute teacher to understand whether the class is ready for the lesson, and it creates a direct line between this lesson and the previous assessment. It sounds like box-filling but it is actually the structural element most correlated with lessons that go well when observed.
</aside>

## Related categories

**[Legal document templates](/legal-document-templates/)** — A birth plan is a planning document; a birth registration is a legal document. After a baby arrives, the legal-documents cluster covers the documents required to register the birth (in England and Wales, the deadline is 42 days; in Scotland, 21 days). Travel itineraries sometimes require accompanying documentation — visa applications, insurance certificates — that live in the legal cluster.

**[Business templates](/business-templates/)** — Marketing plans, project proposals, and operational schedules blur the boundary between planning and business. The business cluster covers the financial and client-facing documents; this cluster covers the time-management and scheduling layer.

**[Resume & career templates](/resume-templates/)** — Job search planning — tracking applications, scheduling interviews, following up — benefits from the weekly planner and daily schedule templates in this cluster alongside the career documents in the resume cluster.

**[Life event templates](/life-event-templates/)** — Milestone events require both planning documents (itinerary, schedule, meal plan for the reception) and life-event documents (invitations, programmes). A graduation party needs a run-of-show schedule from this cluster and invitations from the life-events cluster.

**[Education templates](/education-templates/)** — Lesson plans are primarily a planning document, but they live at the intersection of planning and education. The education cluster covers student-facing tools (Cornell notes, graphic organisers); this cluster covers the teacher-facing planning layer. The two clusters are frequently used together.

**[Productivity templates](/productivity-templates/)** — Weekly planners and daily schedules overlap with the productivity cluster's to-do lists, timesheets, and chore charts. The distinction is that planning templates are forward-looking (here is what I intend to do) while productivity templates are often used for tracking (here is what was done, when, by whom).

**[Design templates](/design-templates/)** — Visual schedules and storyboards sit at the intersection of design and planning. Storyboards are a planning tool for video and creative production; they are in the design cluster because the visual element is primary, but they serve a planning function.
